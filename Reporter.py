...
class Reporter:
    ...
    def __init__(self, filename):
        ...
        outFile.write("# Iteration, Elapsed time, Mean value, Best value, Cycle, Avg mutation rate\n")
        outFile.close()
    ...
    def report(self, meanObjective, bestObjective, bestSolution, avg_mut_rate):
        if time.time() - self.startTime < self.allowedTime + self.writingTime:
            ...
            outFile.write(str(avg_mut_rate) + self.delimiter)
